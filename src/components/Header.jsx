  ...
  return (
    <header className="py-1 px-7 flex justify-between items-center sticky top-0 z-50 w-full border-b-[0.3px] border-[#babaff] bg-black">
      ...
      <div className="flex lg:gap-14 gap-4 items-center">
        <img className=" md:w-16 w-12" src={`/${import.meta.env.BASE_URL}Images/logo.png`} alt="logo-img" />        <div className="hidden md:flex gap-5 items-center">
      ...
      {/* Mobile Menu - Visibile only on mobile */}
