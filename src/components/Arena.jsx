      ...
      <div className="lg:max-w-[90%] mx-auto grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
        ...
        <div className="md:col-span-1 space-y-4 md:space-y-6">
          ...
          >
            ...
            <div className="absolute h-full w-full">
              <img src="/gaming/Images/bento-card1.png" alt="card-1" />                <button className="absolute bottom-0 h-16  w-full bg-black bg-opacity-70 text-2xl font-bold hover:text-yellow-400 transition-all text-nowrap">
          ...
          >
              <video
                ...
                muted
                playsInline
                src="/gaming/Video/bento-card2.mp4"
            ></video>
          </div>
        </div>
        ...
        <div className="md:col-span-2 space-y-4 md:space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 md:gap-6">
            ...
            <div className="relative overflow-hidden rounded-3xl border border-white aspect-square transform transition-transform duration-300 hover:scale-105">
              <video
                ...
                muted
                playsInline
                src="/gaming/Video/bento-card3.mp4"
              ></video>
            ...
            <div className="relative overflow-hidden rounded-3xl border border-white aspect-square transform transition-transform duration-300 hover:scale-105">
              <video
                ...
                muted
                playsInline
                src="/gaming/Video/bento-card4.mp4"
              ></video>
              <h1 className="absolute bottom-2 left-1/2 transform -translate-x-1/2 z-10 font-extrabold text-2xl">
                Floralynx
              </h1>
            ...
            <div className="relative overflow-hidden rounded-3xl border border-white aspect-square transform transition-transform duration-300 hover:scale-105">
              <video
                ...
                muted
                playsInline
                src="/gaming/Video/bento-card5.mp4"
              ></video>
              <h1 className="absolute bottom-2 left-1/2 transform -translate-x-1/2 z-10 font-extrabold text-2xl">
                Titonar
              </h1>
          ...
          <div className="relative overflow-hidden rounded-3xl border border-white aspect-[16/9] md:col-span-2 transform transition-transform duration-300 hover:scale-[1.02]">
            <img src="/gaming/Images/bento-card5.png" alt="card-6" />
