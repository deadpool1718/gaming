    ...
    <div className="relative w-full h-screen overflow-hidden mb-[10%]">
      ...
      <div className="relative z-10 flex md:flex-row flex-col items-center w-full h-full pt-4">
        ...
        <div className="w-full md:w-2/4 flex flex-col md:ml-10">
          ...
          <div
            className="bg-gray-900/80 backdrop-blur-sm rounded-lg pt-4 mb-4 border border-gray-800 shadow-[0_0_15px_rgba(167,139,250,0.2)]"
          >
          ...
          <div className="grid grid-cols-2 gap-4">
            {/* VIKI CARD */}
            <div
              className="relative bg-gray-900/80 backdrop-blur-sm rounded-lg p-3 border flex flex-col justify-between px-12 items-center cursor-pointer transition-all duration-300"
            ...
            >
              ...
              <div className="w-20 h-20 bg-gray-800/50 rounded-md flex items-center justify-center mb-2">
                <img src={`/${import.meta.env.BASE_URL}Images/VIKI.png`} alt="VIKI-IMG" />
              </div>
              {/* Star rating */}
              <div className="flex ">
                {[...Array(3)].map((_, i) => (
            ...
            >
              ...
              {/* Avatar visual placeholder */}
              <div className="w-20 h-20 bg-gray-800/50 rounded-md flex items-center justify-center mb-2">
                <img src={`/${import.meta.env.BASE_URL}Images/EVA.png`} alt="EVA-IMG" />
              </div>
              {/* Star rating */}
              <div className="flex ">
                {[...Array(4)].map((_, i) => (
