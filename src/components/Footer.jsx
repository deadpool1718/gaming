...
const Footer = () => {
  return (
    <footer className="flex items-center justify-between lg:mt-[15%] mt-[25%] py-8 lg:px-32 md:px-16 px-8 border-t-[0.3px] border-[#babaff]">
      <img className="h-10" src={`${import.meta.env.BASE_URL}Images/illu-text.png`} alt="illu-text" />
      <img className="h-16 md:inline hidden" src={`${import.meta.env.BASE_URL}Images/illu-logo.png`} alt="illu-logo" />
